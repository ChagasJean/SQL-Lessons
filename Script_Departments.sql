...
/* FAZER O COUNT É IMPORTANTE PARA QUE VOCê SAIBA A ORDEM QUAL COLOCAR OS ATRIBUTOS PARA TUNAR SEU QUERY 
QUANDO UTILIZAR O "OR", O ATRIBUTO COM MAIORES QUANTIDADES IRÁ NA FRENTE
QUANDO UTILIZAR O "AND", O ATRIBUTO COM MENORES QUANTIDADES IRÁ NA FRENTE
*/

/* CONTAGEM DO NÚMERO DE REGISTROS NA TABELA */
SELECT COUNT(*) FROM FUNCIONARIOS;

/* CONTAGEM ESPÉCIFICA PARA SABER, SEPARADAMENTE, QUANTOS DEPARTAMENTOS EXISTEM */
SELECT COUNT(*) AS "QTD_FUNCIONÁRIOS", DEPARTAMENTO FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO
ORDER BY 1;

/* TRAZER FUNCIONÁRIOS DO DEPARTAMENTOS DE FILMES OU DE DEPARTAMENTO DE ROUPAS */
/* QTD_FUNCIONÁRIOS
21 Filmes
53 Roupas
*/
SELECT ID, NOME, SEXO, DEPARTMENTO FROM FUNCIONARIOS
WHERE DEPARTMENTO = "Roupas" OR DEPARTMENTO = "Filmes";

/* TRAZER FUNCIONÁRIAS DO DEPARTAMENTO DE FILMES OU DEPARTAMENTO DO LAR. TRAZER SEUS EMAILS TAMBÉM */
/* QTD_FUNCIONÁRIOS
21 Filmes
52 Lar
*/
SELECT ID, NOME, SEXO, DEPARTAMENTO, EMAIL FROM FUNCIONARIOS
WHERE (DEPARTAMENTO = "Lar" AND SEXO = "Feminino") OR (DEPARTAMENTO = "Filmes" AND SEXO = "Feminino");

/* TRAZER OS FUNCIONÁRIOS MASCULINOS OU OS FUNCIONÁRIOS QUE TRABALHAM NO JARDIM */
/* QTD_FUNCIONÁRIOS
47 Jardim
*/
SELECT ID, NOME, SEXO, DEPARTAMENTO FROM FUNCIONARIOS
